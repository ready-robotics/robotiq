...
# TODO (adam.calhoon) RPI-92: This test node is not currently functional because the gripper node was reset to use a
# single topic for actions until dual gripper support can be rolled into the front-end.
def main():
